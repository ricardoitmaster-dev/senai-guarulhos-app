...
DADOS_CURSOS = {
    ...
    "Gestão e Logística": ["ALMOXARIFE", "ASSISTENTE ADMINISTRATIVO", “AULXILIAR ADMINISTRATIVO”, “ASSISTENTE DE RECURSOS HUMANOS”, “ASSSISTENTE FINANCEIRO”, “GESTÃO DE PESSOAS E LIDERANÇA”, “GESTÃO EM ENGENHARIA DE PRODUÇÃO”, "LOGÍSTICA INTEGRADA"]
}
...
if os.path.exists(path_fachada):
    ...
    st.markdown(f'''
        <div style="text-align: center;">
            <div class="moldura-3d-ajustada" style="display: inline-block; width: auto; max-width: 90%;">
                <img src="data:image/jpeg;base64,{fachada_base}" style="display: block; width: auto; max-height: 350px;">
            </div>
        </div>
    ''', unsafe_allow_html=True)
